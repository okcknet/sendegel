									...
									<div class="panel-group" id="accordion1">
										...
										<div class="panel">
											...
											<div id="accordion1-item1" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/aziz-akgul.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion1-item2" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/mehmet-arda.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion1-item3" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/ibrahim-betil.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion1-item4" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/kerim-uralli.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion1-item5" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/derya-sel-bozkurt.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion1-item6" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/asli-aysen-aydin.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion1-item7" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/kaddafi-bozkurt.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion1-item8" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/turgut-derman.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion1-item9" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/samir-bayraktar.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion1-item10" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/tugba-jabban.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion1-item11" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/ceren-kali.php' ?></div>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="panel-group" id="accordion2">
										...
										<div class="panel">
											...
											<div id="accordion2-item2" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/nuh-hakan-oflazer.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion2-item3" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/dara-aslan.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion2-item4" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/didem-unsur.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion2-item5" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/sema-emek.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion2-item6" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/cem-aksehirlioglu.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion2-item7" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/abdullah-hardura.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion2-item9" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/mustafa-ciper.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion2-item11" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/sema-gumus.php' ?></div>
												</div>
											</div>
										</div>
									...
									<div class="panel-group" id="accordion3">
										...
										<div class="panel">
											...
											<div id="accordion3-item1" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/mehmet-bahadir-teke.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion3-item2" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/zeynel-senan.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion3-item3" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/ecehan-bike-geckinli.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion3-item4" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/aytul-tulay-balci.php' ?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel">
											...
											<div id="accordion3-item5" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/mutlu-sen.php' ?></div>
												</div>
											</div>
										</div>
									...
									<div class="panel-group" id="accordion4">
										<div class="panel">
											...
											<div id="accordion4-item1" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/bilge-ogun-bassani.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion4-item2" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/jak-jabes.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion4-item3" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/tayyibe-gulek-domac.php' ?></div>
												</div>
											</div>
										</div>
										<div class="panel">
											...
											<div id="accordion4-item4" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="content"><?php include 'ekibimiz/charlotte-sabbah.php' ?></div>
												</div>
											</div>
										</div>
									</div>
