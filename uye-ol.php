						...
						<div class="section-container align-center">
							<div class="module card card1">
								<div class="card1-item">
									<a href="https://drive.google.com/file/d/1qTJIvbIKpcBtn_caskSxi2IbYAgfrSq7/view" target="_blank" title="Bireysel Üyelik Formu">
								...
								<div class="card1-item">
									<a href="https://drive.google.com/file/d/1PA_XJ33O9Ntg-cNyYgbc-e3FPm7Oi-19/view" target="_blank" title="Tüzel Üyelik Formu">
										<i class="icon icon-paper-2"></i>
										<h4 class="card1-title">Tüzel<br>Üyelik Formu</h4>
										İNDİR
									</a>
								</div>
							</div>
